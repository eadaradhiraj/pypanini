...
Date: 2026-09-05T05:02:36Z
Run: unittest pilots + sweep_gana --all --workers 8 --out tests/sweep_all.csv.
Passes: **367/1166 100%**. Fails: 799. See tests/sweep_all.csv (grep).

## Rules (general)
- Anubandha, redup 7.4.62, yan e/o, kta I~, Nic aorist, krdanta guna, liw Pit/Kit+e+final-cons, yak e+final, luN at/guNa, ASIrliN D/Q, yat vriddhi, yang_krut/yat palatal+Ay->Iy (cAy->cekIyya, 7.3.52), Nic mit/GawAdi hrasva (valaya, mit flag) except kr+T (kraTa->krATaya).
...
| nich_krut | 494 | 01.0379 ting/liw/prathama/eka:puzPuwsPowva |
...
### Next >=97%
- 01.0379 877/895 98.0% | ting/liw/prathama/eka:puzPuwsPowva | ting/liw/prathama/dvi:puzPuwsPOwvatuH | ting/liw/prathama/bahu:puzPuwsPOwvuH | ting/liw/madhyama/eka:puzPuwiTa | ting/liw/madhyama/dv
