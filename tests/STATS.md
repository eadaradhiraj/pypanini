...
Passes: **1106/1156 100%** (95.7%, raw 1106/1166). Fails: 50 scored (60 with 10 skipped). Net matched tokens +8720 across eight nasal iterations (0 worsened).
...
- krdanta mUla yat/ktvA nasal (same 14-root survey; extends mUla rule above): `yat` 14/14 want `m/M` (`SramBya/tumpya/sfmBya/SaMsya/sraMsya`), `ktvA` m-variant 14/14 (`SramBitvA/tumpitvA/SaMsitvA/sraMsitvA`; loss variant left as is, m hits via any-match). Replacement (old `n` misses). 14 improved (+56 tokens: each fid +4 = `yat` M/F/N + `ktvA`), 0 worsened, passes held 1106. `krut` capped misses 276->220; `yangluk_krut` 44->56 and `san_krut` 12->15 are freed-cap artifacts (fid-diff truth: 0 worsened; newly-surfaced `01.0459 san_krut/Satf/M:sisramBizan` queued with san-stem gaps).
...
| yangluk_krut | 56 | 01.0458 yangluk_krut/yat/M:SranByaH |
